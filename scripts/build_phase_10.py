...
def create_notebook(filename, unit_num, title, objectives, markdown_sections, code_sections):
    ...
    for md, code in zip(markdown_sections, code_sections, strict=False):
        cells.append(
            {
                "cell_type": "markdown",
                "metadata": {},
...
create_notebook(
    ...
    [
        "Understand model families, sizes, and tiers",
        "Evaluate trade-offs between cost, latency, and capability",
        "Implement systematic model selection for tasks",
    ],
    [
        [
...
create_notebook(
    ...
    "Context Windows",
    [
        "Understand token counting and window limits",
        "Implement chunking and truncation strategies",
        "Manage context budgets effectively",
    ],
    [
        [
...
create_notebook(
    ...
    [
        "Understand Supervised Fine-Tuning (SFT) and LoRA",
        "Format training data correctly",
        "Recognize when fine-tuning is needed vs RAG/prompting",
    ],
    [
        [
...
create_notebook(
    ...
    [
        ...
        "Evaluate trade-offs for knowledge vs behavior",
        "Build strategy decision logic",
    ],
    [
        [
...
create_notebook(
    ...
    "LLM Cost & Latency",
    [
        "Calculate token costs and pricing",
...
create_notebook(
    ...
    "LLM Security",
    [
        "Identify prompt injection and PII leakage risks",
...
create_notebook(
    ...
    "LLM Evaluation",
    [
        "Understand groundedness, faithfulness, and relevance",
        "Implement LLM-as-judge evaluation",
        "Build evaluation test harnesses",
    ],
    [
...
create_notebook(
    ...
    [
        "Synthesize all Phase 10 concepts",
        "Compare Direct Prompting vs RAG vs Long-Context",
